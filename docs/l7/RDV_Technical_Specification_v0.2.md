...
### Tier Definitions (Approved)

| Tier | Name       | Voting Weight (1-DAO-1-vote) | Requirements (base)                               | Min Time |
|------|------------|------------------------------|---------------------------------------------------|----------|
| 0    | Observer   | 0%                           | Successful registration                           | 0 days   |
| 1    | Active     | 50%                          | ≥ 18 activity points + UMA assertion              | 60 days  |
| 2    | Full       | 100%                         | ≥ 50 activity points + contribution/endorsements + UMA | 120 days |

### Activity Point System (Approved v0.2)

| Action                                      | Points     | Limits / Conditions                                      |
|---------------------------------------------|------------|----------------------------------------------------------|
| Vote in Assembly                            | **1**      | Max 4 points / week                                      |
| Create proposal in Assembly                 | **5**      | Max 2 per month                                          |
| Treasury contribution (verified)            | **1–15**   | 1 pt per 0.1 ETH-eq (capped at 15)                       |
| Verified off-chain contribution             | **10–25**  | Requires evidence + optional peer review                 |
| Peer endorsement from Tier 2 DAO            | **8**      | Max 2 per quarter                                        |
| Service as Meta-Jury member                 | **12**     | Per case                                                 |
| Other significant actions                   | **3–10**   | Requires UMA assertion or Council approval               |

**Additional rules:**
- No single category may exceed 60% of total activity points (anti-farming).
- Points older than 180 days lose 50% of their value (time decay).
- Meta-Jury may cancel points obtained through detected gaming.

### Virtue Acceleration (Approved)

Virtue Score (sum of sophia + andreia + dikaiosyne + sophrosyne from CNOTA) accelerates Tier progression as follows:

| Virtue Score Range | Acceleration Effect                                              |
|--------------------|------------------------------------------------------------------|
| < 250              | No acceleration                                                  |
| 250 – 299          | −10% required activity points                                    |
| 300 – 339          | −20% required activity points **or** −15 days min time (DAO chooses) |
| ≥ 340              | −30% required activity points **+** −20 days min time            |

**Example:**  
A DAO with Virtue Score 355 seeking Tier 2 needs only **35 activity points** and **100 days** instead of the base 50 points / 120 days.

High Virtue does not grant free advancement — real activity is still required — but it meaningfully shortens the path in line with the Virtue-first principle.

### UMA Assertion Flow for Tier Advancement

1. DAO or authorized operator submits **UMA Assertion**:
   - Claim: “DAO 0x… has met all requirements for Tier X (including any Virtue acceleration applied)”
   - Supporting data: activityScore, timestamps, Virtue Score snapshot, evidence hashes
   - Bond posted

2. Challenge window (48–72 hours)
...
## 10. Configurable Parameters (Approved)

| Parameter                      | Approved Value     | Change Authority                  |
|--------------------------------|--------------------|-----------------------------------|
| Tier 1 min days                | 60                 | Council 7/11 + Assembly           |
| Tier 2 min days                | 120                | Council 7/11 + Assembly           |
| Tier 1 activity points (base)  | **18**             | Council 7/11                      |
| Tier 2 activity points (base)  | **50**             | Council 7/11                      |
| Soft-cap threshold             | 40 active DAOs     | Council 7/11 + Assembly           |
| Challenge window (UMA)         | 48–72 h            | Council                           |
| Virtue acceleration tiers      | 250 / 300 / 340    | Council + ethics experts          |
| Max points from single category| 60% of total       | Council 7/11                      |
| Point time decay               | 50% after 180 days | Council 7/11                      |
...
1. Write Solidity interfaces + UMA integration adapters
2. Implement Phase 1 (BridgeDAORegistry + Tier 0/1 logic) in StoicMatrixAitest
3. Create corresponding L4 ConstitutionalAudit for the RDV module
4. Publish summary to Moltbook for community review
5. Begin Phase 2 (UMA assertion flow for Tier upgrades)

---

**Document status:** Parameters Approved — Ready for implementation.  
